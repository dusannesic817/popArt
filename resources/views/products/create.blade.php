                                ...
                                <form method="POST" action="{{ route('products.store') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="parent-category" class="form-select"
                                            aria-label="Default select example" name="parent_id" name="parent_category">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="child-category" class="form-select"
                                    ...
                                    <div class="form-check d-inline-block">
                                        <input class="form-check-input" type="radio" name="condition"
                                            id="radioDefault2" value="polovno" checked>
